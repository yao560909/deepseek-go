...
import (
	...
	"encoding/json"
	"fmt"
	"github.com/yao560909/deepseek-go/internal"
	"github.com/yao560909/deepseek-go/internal/apierror"
	"github.com/yao560909/deepseek-go/internal/apiform"
	"github.com/yao560909/deepseek-go/internal/apiquery"
	"io"
	"math"
	"math/rand"
	"net/http"
...
func getDefaultHeaders() map[string]string {
	return map[string]string{
		"User-Agent": fmt.Sprintf("DeepSeek/Go %s", internal.PackageVersion),
	}
}
